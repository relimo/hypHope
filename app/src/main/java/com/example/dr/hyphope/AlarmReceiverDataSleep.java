...
/**
 * this class saves  sleep data of the last day in DB and calculate the time we need to check if the user wake up already - for tomorrow morning
 */
public class AlarmReceiverDataSleep extends BroadcastReceiver {
...
//                                        },
                            ...
                            String wakeUpTime=jsonsleepData.getString("wakeUpTime");
...
//                                        Log.d("Run Wake up time", obj.getString("wakeUpTime"));
                            Log.d("Run wake up: ",wakeUpTime );
                            long idLength=dalDynamic.getRecordIdAccordingToRecordName("sleepLength");
                            long idWakeUp=dalDynamic.getRecordIdAccordingToRecordName("wakeUpTime");
                            Log.d("Run id op len: ",idLength+"" );
                            Log.d("Run id op wakeup: ",idWakeUp+"" );
                            ...
                            Record record=new Record(date,day_week,idLength,sleepLength);
                            long id2=dalDynamic.addRowToTable2(record);
                            Log.d("Run id table 2: ",id2+"");
                            record=new Record(date,day_week,idWakeUp,wakeUpTime);
                            id2=dalDynamic.addRowToTable2(record);
                            Log.d("Run id table 2: ",id2+"");
